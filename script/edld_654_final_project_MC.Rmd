...
points(density(predicted_ridge_te[group_1,]$Never, adjust = 1.5),col = "orange",lty=2,type='l')
...
points(density(predicted_lasso_te[group_1,]$Never,adjust=1.5),col="orange",lty=2,type='l')
legend("topright", c("AnyUse","Never"), col = c("lightblue","orange"), lty=c(1,2), bty='n')
