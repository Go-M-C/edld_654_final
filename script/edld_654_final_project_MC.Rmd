...
plot(density(predicted_ridge_te[group_0,]$Never, adjust = 1.5),col = "lightblue",xlab = '', main = "Logistic Model_ridge penalty")
...
```{r}
plot(density(predicted_lasso_te[group_0,]$Never,adjust=1.5), col="lightblue",xlab = '', main = 'Logistic Model_lasso penalty')
